  ...
  <main>
    ...
    <section class="container mx-auto mt-6" id="comments">
      <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        ...
        <div class="p-6">
          <div
            class="text-white font-bold p-4 text-center rounded mb-4"
...
<script>
import { db, songsDocument, auth, commentsCollection } from '@/includes/firebase'
...
export default {
  ...
  async created() {
    ...
    const docSnapshot = await getDoc(doc(db, songsDocument, this.$route.params.id))

    // The song is not exist
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      // Don`t need to get comments again after adding comment
      // https://eslint.org/docs/latest/rules/no-plusplus#rule-details
      this.song.comment_count += 1
      // https://firebase.google.com/docs/firestore/manage-data/add-data#update-data
      await updateDoc(doc(db, songsDocument, this.$route.params.id), {
