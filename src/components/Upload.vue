<template>
  <div class="bg-white rounded border border-gray-200 relative flex flex-col">
    ...
    <div class="p-6">
      ...
      <div
        class="w-full px-10 py-20 rounded text-center cursor-pointer border border-dashed border-gray-400 text-gray-400 transition duration-500 hover:text-white hover:bg-green-500 hover:border-green-500 hover:border-solid"
        :class="{ 'bg-green-500 border-green-500 border-solid text-white': is_dragover }"
        @drag.prevent.stop=""
      ...
      <div class="mb-4" v-for="upload in uploads" :key="upload.name">
        ...
        <div class="font-bold text-sm mb-1" :class="upload.text_class">
          <i :class="upload.icon" class="mr-1"></i>
          {{ upload.name }}
        </div>
